    ...
    <header className="border-b border-obscura-border bg-obscura-dark/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm text-gray-400">
          <Link href="/bridge" className="hover:text-white transition-colors text-blue-400 hover:text-blue-300 font-medium">Bridge</Link>
          <Link href="/send" className="hover:text-white transition-colors">Privacy TX</Link>
